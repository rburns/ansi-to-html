...
describe('ansi to html', function () {
    describe('constructed with no options', function () {
        ...
        it('is able to skip disabling underline', function () {
        ...
        it('skips rendering un-italic code appropriately', function () {
    ...
    describe('with stream option enabled', function () {
        ...
        it('does not persist styles beyond their usefulness', function () {
            ...
            let result = '<span style="color:#A00">red</span><span style="color:#A00">also red</span><span style="color:#A00"><span style="color:#000">black</span></span><span style="color:#000">and black</span>';

            test(text, result, {stream: true});

            text = ['\x1b[41mred', 'also red', '\x1b[40mblack', 'and black'];
            result = '<span style="background-color:#A00">red</span><span style="background-color:#A00">also red</span><span style="background-color:#A00"><span style="background-color:#000">black</span></span><span style="background-color:#000">and black</span>';

            test(text, result, {stream: true});

            text = ['\x1b[101mred', 'also red', '\x1b[100mblack', 'and black'];
            result = '<span style="background-color:#F55">red</span><span style="background-color:#F55">also red</span><span style="background-color:#F55"><span style="background-color:#555">black</span></span><span style="background-color:#555">and black</span>';
        ...
        it('processes underline, blink and conceal', function () {
            ...
            let result = '<u>underlined <blink>blink <span style="display:none">conceal</span></blink></u>';

            test(text, result, {stream: true});

            // Check coverage for text as array
            text = ['\x1b[4munderlined \x1b[5mblink \x1b[8mconceal'];
            result = '<u>underlined <blink>blink <span style="display:none">conceal</span></blink></u>';
